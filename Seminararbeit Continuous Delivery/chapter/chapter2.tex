...
\begin{description}
	\item[\suchstring{Einfach} =] ("'Continuous Delivery"` OR "'Deployment"`) \\AND\\ ("'Deployment"` OR "'Tests"` OR "'Qualitätssicherung"` OR "'quality assurance"`)
\end{description}
